...
import StaticData from './data.json';
    ...
    export default {
        ...
        methods: {
            ...
            getAvailability() {
                let app = this;
                  console.warn('Static Data Example')

                  console.groupCollapsed('Static Data Days')
                  console.table(StaticData.days)
                  app.availableDays = StaticData.days;

                  console.groupEnd();


                  console.groupCollapsed('Static Data Timeslots')
                  console.table(StaticData.timeslots);
                  app.timeslot_data = StaticData.timeslots;
                  console.groupEnd();
